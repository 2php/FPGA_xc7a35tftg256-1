...
#define reg 0x50000
#define is_data 0x70000
#define reset 0x00000
#define nreset 0x40000
//////////////////////////////////////////////////////////////////////////////////	 
//������ֻ��ѧϰʹ�ã�δ��������ɣ��������������κ���;
...
{
	Xil_Out32(XPAR_HIER_PERIPH_HIER_LCD_LCD_S00_AXI_BASEADDR+MYIP_S00_AXI_SLV_REG0_OFFSET, is_data + data);
}
void LCD_WR_REG(u16 data)
{ 
	Xil_Out32(XPAR_HIER_PERIPH_HIER_LCD_LCD_S00_AXI_BASEADDR+MYIP_S00_AXI_SLV_REG0_OFFSET, reg + data);
}
...
{ 
	...
	Xil_Out32(XPAR_HIER_PERIPH_HIER_LCD_LCD_S00_AXI_BASEADDR + MYIP_S00_AXI_SLV_REG0_OFFSET, nreset);
		Xil_Out32(XPAR_HIER_PERIPH_HIER_LCD_LCD_S00_AXI_BASEADDR + MYIP_S00_AXI_SLV_REG0_OFFSET, reset);
		Xil_Out32(XPAR_HIER_PERIPH_HIER_LCD_LCD_S00_AXI_BASEADDR + MYIP_S00_AXI_SLV_REG0_OFFSET, nreset);
  	lcddev.id = 0x5510;
  	LCD_Display_Dir(0);
